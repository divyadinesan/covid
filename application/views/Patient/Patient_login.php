        ...
        <div class="col-md-offset-4 col-md-4 text-center">
            <h1 class='text-white'>Signup Now</h1>
              <div class="form-login"></br>
                ...
                <form action="<?php echo base_url('index.php/Patient_controller/Patient_login_form')?>" method="post" enctype="multipart/form-data">
                ...
                <br>
                <div align="right">
                 <a href="<?php echo base_url('index.php/Patient_controller/Patient_registration')?>"><h5 style="color: white">Register Here</h5></a>
                 </div>
