            ...
            <div class="container py-lg-5 py-md-4 py-2">
                ...
                <div class="row mt-lg-5 mt-4 text-center">
                    ...
                    <div class="col-lg-4 col-md-6 mt-md-0 mt-5">
                        <div class="grids5-info">
                            <a href="#service" class="d-block zoom"><img src="<?php echo base_url('Asset/Patient/images/s2.jpg')?>" alt=""
                                    class="img-fluid" /></a>
                            <div class="blog-info">
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    ...
                                    <div class="testi-des">
                                        <div class="test-img"><img src="<?php echo base_url('Asset/Patient/images/team1.jpg')?>" class="img-fluid"
                                                alt="client-img">
                                        </div>
