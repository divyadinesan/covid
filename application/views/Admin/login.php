...
<div class="w3layouts-main">
	<h2>Sign In Now</h2>
		<form action="<?php echo base_url('index.php/Admin_controller/login_check')?>" method="post">
		...
		<div align="center">
		<a href="<?php echo base_url('index.php/Index_controller/index')?>">
			<img src="<?php echo base_url('Asset/Patient/images/home.png')?>"style="width:90px;height:90px">
		</a>
	</div>
</div>
</div>
