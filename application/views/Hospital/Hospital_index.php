...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!--//meta tags ends here-->
	<!--booststrap-->
	<link href="<?php echo base_url('Asset/Hospital/css/bootstrap.css')?>" rel="stylesheet" type="text/css" media="all">

	<!--//booststrap end-->

	<!-- font-awesome icons -->
	<link href="<?php echo base_url('Asset/Hospital/css/font-awesome.css')?>" rel="stylesheet">
	<!-- //font-awesome icons -->
	<link rel="stylesheet" href="<?php echo base_url('Asset/Hospital/css/chocolat.css')?>" type="text/css" media="screen" />
	<!-- gallery-->
	<link rel="stylesheet" href="<?php echo base_url('Asset/Hospital/css/owl.carousel.css')?>" type="text/css" media="all">
	<!-- clients-->

	<link rel="stylesheet" href="<?php echo base_url('Asset/Hospital/css/flexslider.css')?>" type="text/css" media="screen" />
	<!-- banner text slider-->
	<!--stylesheets-->
	<link href="<?php echo base_url('Asset/Hospital/css/style.css')?>" rel='stylesheet' type='text/css' media="all">
	<!-- banner text slider-->

	<link href="<?php echo base_url('Asset/Hospital///fonts.googleapis.com/css?family=Barlow+Condensed:300,400,500,600')?>" rel="stylesheet">
			...
			<nav class="navbar navbar-default navbar-fixed-top">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a class="page-scroll scroll" href="#clients">Client</a></li>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="out-info">
						<img src="<?php echo base_url('Asset/Hospital/images/g1.jpg')?>" alt="" />
		...
		<div class="container">
			<div class="imgg-info-w3">
				<div class="col-md-6 left-about-img">
					...
					<img src="<?php echo base_url('Asset/Hospital/images/a1.jpg')?>" class="img-responsive s1" alt="s1">
				</div>
		...
		<div class="gallery-info">
			<div class="col-md-6 col-sm-6 gallery-grids glry-grid1 ">
				<div class="gallery-grids-top w3_agile_gallery_grid ">
					<a class="b-link-stripe" href="images/g4.jpg" data-lightbox="example-set" data-title="Making your life easier. ">
							<img src="<?php echo base_url('Asset/Hospital/images/g4.jpg')?>" class="img-responsive" alt="">
							<div class="b-wrapper">			
							</div>
						</a>
				</div>
				<div class="gallery-grids-top">
					<div class="col-md-6 col-sm-6 bottom-grids w3_agile_gallery_grid">
						<a class="b-link-stripe" href="images/g1.jpg" data-lightbox="example-set" data-title="Making your life easier.">
								<img src="<?php echo base_url('Asset/Hospital/images/g1.jpg')?>" class="img-responsive" alt="">
								<div class="b-wrapper">			
								</div>
							</a>
					</div>
					<div class="col-md-6 col-sm-6 bottom-grids w3_agile_gallery_grid">
						<a class="b-link-stripe" href="images/g2.jpg" data-lightbox="example-set" data-title="Making your life easier.">
								<img src="<?php echo base_url('Asset/Hospital/images/g2.jpg')?>" class="img-responsive" alt="">
								<div class="b-wrapper">				
								</div>
							</a>
					</div>
			...
			<div class="col-md-3 col-sm-3 gallery-grids w3_agile_gallery_grid glry-grid2">
				<a class="b-link-stripe " href="images/g3.jpg" data-lightbox="example-set">
						<img src="<?php echo base_url('Asset/Hospital/images/g3.jpg')?>" class="img-responsive" alt="">
						<div class="b-wrapper">			
						</div>
					</a>
			</div>
			<div class="col-md-3 col-sm-3 gallery-grids w3_agile_gallery_grid glry-grid3">
				<a class="b-link-stripe" href="images/g6.jpg" data-lightbox="example-set">
						<img src="<?php echo base_url('Asset/Hospital/images/g6.jpg')?>" class="img-responsive" alt="">
						<div class="b-wrapper">				
						</div>
					</a>
				<a class="b-link-stripe" href="images/g5.jpg" data-lightbox="example-set">
						<img src="<?php echo base_url('Asset/Hospital/images/g5.jpg')?>" class="img-responsive" alt="">
						<div class="b-wrapper">			
						</div>
					</a>
			</div>
				...
				<div class="team-row">
					<div class="col-md-4 col-sm-4 col-xs-4 team-grids">
						<div class="team-agile-img">
							<a href="#"><img src="<?php echo base_url('Asset/Hospital/images/t1.jpg')?>" alt="img"></a>
					...
					<div class="col-md-4 col-sm-4 col-xs-4 team-grids">
						<div class="team-agile-img">
							<a href="#"><img src="<?php echo base_url('Asset/Hospital/images/t2.jpg')?>" alt="img"></a>
							<div class="view-caption">
								<div class="t-info">
									<h5>HOD</h5>
									<p>Lara kent</p>
					...
					<div class="col-md-4 col-sm-4 col-xs-4 team-grids">
						<div class="team-agile-img">
							<a href="#"><img src="<?php echo base_url('Asset/Hospital/images/t3.jpg')?>" alt="img"></a>
							<div class="view-caption">
								<div class="t-info">
									<h5>Psyhologist</h5>
									<p>Jack will</p>
				...
				<div class="clients_agile_slider">
					<div id="owl-demo" class="owl-carousel owl-theme">
						<div class="item">
							<div class="agile_tesimonials_content">
								<div class="about-midd-main">
									<img class="agile-img" src="<?php echo base_url('Asset/Hospital/images/c1.jpg')?>" alt="img">
									<h4>Ketty way</h4>
						...
						<div class="item">
							<div class="agile_tesimonials_content">
								<div class="about-midd-main">
									<img class="agile-img" src="<?php echo base_url('Asset/Hospital/images/c2.jpg')?>" alt="img">
									<h4>Cleark Hill</h4>
									<p> Lorem ipsum adipiscing elit, sed do eiusmod idunt ut labore. sed do eiusmod </p>
								</div>
							</div>
						...
						<div class="item">
							<div class="agile_tesimonials_content">
								<div class="about-midd-main">
									<img class="agile-img" src="<?php echo base_url('Asset/Hospital/images/c3.jpg')?>" alt="img">
									<h4>Willson Doe</h4>
									<p> Lorem ipsum adipiscing elit, sed do eiusmod idunt ut labore. sed do eiusmod </p>
								</div>
							</div>
