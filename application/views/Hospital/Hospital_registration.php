        ...
        <div class="col-md-offset-5 col-md-4 text-center">
            <h1 class='text-white'>Signup Now</h1>
              <div class="form-login"></br>
                ...
                <form action="<?php  echo base_url('index.php/Hospital_controller/hospital_register')?>" method="post" enctype="multipart/form-data">
                <input type="text" id="" class="form-control input-sm chat-input" name="name"placeholder="name"/>
                </br></br>
                ...
                <input type="text" id="" class="form-control input-sm chat-input"name="phone" placeholder="phone"/>
                </br></br>
                <input type="text" id="" class="form-control input-sm chat-input" name="c/t"placeholder="city /town"/>
                </br></br>
                <input type="text" id="" class="form-control input-sm chat-input" name="Address"placeholder="Address"/>
                </br></br>
                <input type="text" id="" class="form-control input-sm chat-input" name="experience"placeholder="experience"/>
                </br></br>
               ...
               <div class="form-group">
                ...
                <div class="wrapper">
                 ...
                 <div align="right">
                 <a href="<?php echo base_url('index.php/Hospital_controller/Hospital_login')?>"><h3 style="color: white">Login now</h3></a>
                 </div>
            </div>
        </form>
        </div>
